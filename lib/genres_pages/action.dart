...
import '../home.dart';
class genre_action extends StatefulWidget {
  const genre_action({Key? key}) : super(key: key);

  @override
  _genre_actionState createState() => _genre_actionState();
}

class _genre_actionState extends State<genre_action> {
  @override
  List filmaction=[];
  Future<void>loadactionmovies()async {
    Response response = await get(Uri.parse(
        'https://api.themoviedb.org/3/discover/movie?api_key=c76aa0251cd073cf305fe2c0a51a4fd8&with_genres=28&primary_release_date.gte=1950-03-25&primary_release_date.lte=2021-11-31')) as Response;
