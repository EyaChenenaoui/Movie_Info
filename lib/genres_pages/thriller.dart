...
import '../home.dart';
class genre_thriller extends StatefulWidget {

  @override
  _genre_thrillerState createState() => _genre_thrillerState();
}

class _genre_thrillerState extends State<genre_thriller> {
  @override
  List filmaction=[];
  Future<void>loadactionmovies()async {
    Response response = await get(Uri.parse(
        'https://api.themoviedb.org/3/discover/movie?api_key=c76aa0251cd073cf305fe2c0a51a4fd8&with_genres=53&primary_release_date.gte=1950-03-25&primary_release_date.lte=2021-11-31')) as Response;
